...
```{r mod selection w spatial and urb accounted for, echo = FALSE, message = FALSE, warning = FALSE, include = FALSE}

#BIC scores generated in spatial_mod_selection_with_urb_corrected.R 
load("chtc_outputs/output_modselection/bicspat.txt")
load("chtc_outputs/output_modselection/bicspatr.txt")

#there are 4 nonspatial models which require rel.tol = 1e-16 instead of the default...this doesn't make sense to me, but we don't really need the nonspat...need to discuss w amy 
#load("chtc_outputs/output_modselection/bicnospat.txt")
#load("chtc_outputs/output_modselection/bicnospatr.txt")

bicspattot = rbind(bicspat, bicspatr)

bicref = bicspattot - bicspattot["bicspat", "fnom"] #this is the reference value which has no migterm, no rurality 

bictable = data.frame("DF" = rep(c(1,2,3,4,5),4),
                      "Including Migration" = c(rep(TRUE, 10), rep(FALSE, 10)),
                      "Including Rurality" = c(rep(TRUE, 5), rep(FALSE, 5), rep(TRUE, 5), rep(FALSE,5)),
                      "Change in BIC" = c(bicref["bicspatr", "fm"],
                                          bicref["bicspatr", "fff2"],
                                          bicref["bicspatr", "fff3"],
                                          bicref["bicspatr", "fff4"],
                                          bicref["bicspatr", "fff5"],
                                          bicref["bicspat", "fm"],
                                          bicref["bicspat", "fff2"],
                                          bicref["bicspat", "fff3"],
                                          bicref["bicspat", "fff4"],
                                          bicref["bicspat", "fff5"],
                                          bicref["bicspatr", "fnom"],
                                          bicref["bicspatr", "fff2_nomig"],
                                          bicref["bicspatr", "fff3_nomig"],
                                          bicref["bicspatr", "fff4_nomig"],
                                          bicref["bicspatr", "fff5_nomig"],
                                          bicref["bicspat", "fnom"],
                                          bicref["bicspat", "fff2_nomig"],
                                          bicref["bicspat", "fff3_nomig"],
                                          bicref["bicspat", "fff4_nomig"],
                                          bicref["bicspat", "fff5_nomig"]))
ggplot(data=bictable, aes(y = Change.in.BIC, color = Including.Migration, shape = Including.Rurality, x = DF)) + geom_point()
```
